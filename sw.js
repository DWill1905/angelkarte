...
const CACHE='angelkarte-shell-v40';
const TILES='angelkarte-tiles-v1';
const SHELL=[
  './','index.html','manifest.json',
  /* ES-Module (App-Code) */
  'js/app.js','js/state.js','js/dom.js','js/util.js','js/data.js','js/astro.js','js/mapcore.js',
  'js/region.js','js/ui.js','js/map.js','js/tackle.js','js/plan.js','js/sicht.js','js/rating.js','js/reed.js','js/saison.js','js/myspots.js','js/weather.js',
