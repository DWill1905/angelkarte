...
export function kbHtml(){
  ...
  if(state.WX){
    if(state.WX.trendVal<=-1.5) h+='<p style="margin-bottom:9px"><b>Druck fällt ('+state.WX.trendVal.toFixed(1)+' hPa/3h):</b> Fresslaune – aktiver und schneller führen, jetzt ans Wasser!</p>';
