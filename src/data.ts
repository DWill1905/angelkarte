...
import type { CatInfo, Region, Schonzeit, Spot } from './types';
...
export const SCHON_MV: Schonzeit[] = [
...
export const SCHON_RLP: Schonzeit[] = [
...
export const SCHON_EL: Schonzeit[] = [
...
export const SCHON_MA: Schonzeit[] = [
...
export const REGIONS_EMBEDDED: Region[] = [
 ...
 {id:'mecklenburg',geprueft:'2026-07',name:'Mecklenburgische Kleinseenplatte (MV)',nachtangeln:'frei',kurz:'Kleinseenplatte',packliste:['Fischereischein + Fischereiabgabe MV (10€) + ggf. Touristenschein','Anker-Pflicht – Schleppen & Driften verboten, max. 2 Handangeln','Tageslimit: max. 3 Edelfische gesamt (Aal, Hecht, Zander, Karpfen)','Mind. 5–10 m Abstand zum Schilf (Naturschutz) – nicht ans Schilf fahren','Urlauber-Fischereischein ohne Prüfung möglich (Ausgabe: Amt/Rathaus/Tourist-Info)','Echolot (Scharkanten weit draußen)','Stahl-/Titanvorfach (hohe Hechtdichte)','Mückenschutz (Wald überflutet)','Kescher, Kopflampe, Regenjacke'],
  ...
  regeln:[
   {titel:'Kartenregeln Seenfischerei Obere Havel (~5.300 ha)',punkte:['Max. 2 Handangeln, Angeln ständig beaufsichtigen','Boot verankern – Schlepp- und Driftangeln verboten!','Schilfgürtel, Seerosenfelder und Fischschonbezirke nicht befahren/beangeln','50 m Abstand zu Fischereigeräten, 100 m zu Schleusen/Stromwehren','Entnahme: max. 3 Fische/Tag gesamt aus Hecht, Zander, Aal, Karpfen','Entnahmefenster: Hecht über 85, Zander über 75, Barsch über 40 cm zurücksetzen','Nachtangeln erlaubt · der Fischer hat Vorrecht','Kinder bis zum vollendeten 14. Lebensjahr (ohne Fischereischein): nur mit einer Friedfischrute, kein Nachtangeln']},
