...
const KLASSE = 'map-fs';
function nativeAn(el) {
    const fn = el.requestFullscreen || el.webkitRequestFullscreen || el.msRequestFullscreen;
    if (typeof fn === 'function') {
        try {
            fn.call(el);
        }
        catch (e) { /* egal, CSS-Vollbild greift */ }
    }
}
function nativeAus() {
    const d = document;
...
export function fullscreenAktiv() {
