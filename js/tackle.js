...
function zugangAus(s, w) {
    ...
    if (s.keinBoot)
        return 'Vom Ufer beangelbar – Krautkanten, Einläufe und Stege ansteuern. Boot/Belly-Boot hier verboten (Gewässerordnung) – Strecke machen statt Reichweite mit Gerät erkaufen.';
...
export function tackleHtml(s) {
    ...
    const SDOT = { fruehjahr: '#5C7A3D', sommer: '#C79000', herbst: '#A6521F', winter: '#3A608F' };
